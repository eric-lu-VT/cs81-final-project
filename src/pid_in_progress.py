...
class FollowWall():
    ...
    def pd_controller(self):
        ...
        if not self.reached_ball:
            print("BALL TOO FAR")                                       
            self.x_error = self.ball_x - (self.odometry_x + self.ball_offset) # might cause issues, think about this with respect to rotation
            ...
            print("BALL REACHED")
            #self.move(self.linear_velocity, 0) # Ball is in the correct position, following predetermined route back
